...
#define PI 3.1415926535897932384626433832795029L
	...
	//************************************
	// Method:    CDxAnimationUI
	// FullName:  UiLib::CDxAnimationUI::CDxAnimationUI
	// Access:    public 
	// Returns:   
	// Qualifier:
	// Parameter: const CDxAnimationUI & src
	// Note:	  
	//************************************
	...
	//************************************
	// Method:    CDxAnimationUI
	// FullName:  CDxAnimationUI::CDxAnimationUI
	// Access:    public 
	// Returns:   
	// Qualifier:
	// Parameter: UITYPE_ANIM AnimType
	// Parameter: DWORD dwStartTick
	// Parameter: DWORD dwDuration
	// Parameter: COLORREF clrBack
	// Parameter: COLORREF clrKey
	// Parameter: RECT rcFrom
	// Parameter: int xtrans
	// Parameter: int ytrans
	// Parameter: int ztrans
	// Parameter: int alpha
	// Parameter: float zrot
	// Note:	  
	//************************************
