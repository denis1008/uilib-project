...
namespace UiLib {
	...
	//************************************
	// Method:    SelectMultiItem
	// FullName:  CListUI::SelectMultiItem
	// Access:    public 
	// Returns:   bool
	// Qualifier:
	// Parameter: int iIndex
	// Parameter: bool bTakeFocus
	// Note:	  
	//************************************
	bool CListUI::SelectMultiItem( int iIndex, bool bTakeFocus /*= false*/ )
	{
		...
		{
			throw "CListUI::SelectMultiItem";
		}
	}
	//************************************
	// Method:    SetSingleSelect
	// FullName:  CListUI::SetSingleSelect
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: bool bSingleSel
	// Note:	  
	//************************************
	void CListUI::SetSingleSelect( bool bSingleSel )
	{
		...
		{
			throw "CListUI::SetSingleSelect";
		}
	}
	//************************************
	// Method:    GetSingleSelect
	// FullName:  CListUI::GetSingleSelect
	// Access:    public 
	// Returns:   bool
	// Qualifier: const
	// Note:	  
	...
	bool CListUI::GetSingleSelect() const
	{
		...
		{
			throw "CListUI::GetSingleSelect";
		}
	}
	//************************************
	// Method:    UnSelectItem
	// FullName:  CListUI::UnSelectItem
	// Access:    public 
	// Returns:   bool
	// Qualifier:
	// Parameter: int iIndex
	...
	bool CListUI::UnSelectItem( int iIndex )
	{
		...
		{
			throw "CListUI::UnSelectItem";
		}
	}
	//************************************
	// Method:    SelectAllItems
	// FullName:  CListUI::SelectAllItems
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Note:	  
	...
	void CListUI::SelectAllItems()
	{
		...
		{
			throw "CListUI::SelectAllItems";
		}
	}
	//************************************
	// Method:    UnSelectAllItems
	// FullName:  CListUI::UnSelectAllItems
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Note:	  
	...
	void CListUI::UnSelectAllItems()
	{
		...
		{
			throw "CListUI::UnSelectAllItems";
		}
	}
	//************************************
	// Method:    GetSelectItemCount
	// FullName:  CListUI::GetSelectItemCount
	// Access:    public 
	// Returns:   int
	// Qualifier: const
	// Note:	  
	...
	int CListUI::GetSelectItemCount() const
	{
		...
		{
			throw "CListUI::GetSelectItemCount";
		}
	}
	//************************************
	// Method:    GetNextSelItem
	// FullName:  CListUI::GetNextSelItem
	// Access:    public 
	// Returns:   int
	// Qualifier: const
	// Parameter: int nItem
	...
	int CListUI::GetNextSelItem( int nItem ) const
	{
		...
		{
			throw "CListUI::GetNextSelItem";
		}
	}

	//************************************
	// Method:    SetCheckImgSize
	// FullName:  CListUI::SetCheckImgSize
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: SIZE szCheckImg
	// Note:	  
	//************************************
	void CListUI::SetCheckImgSize( SIZE szCheckImg )
	{
		...
		{
			throw "CListUI::SetCheckImgSize";
		}
	}

	//************************************
	// Method:    SetIconImgSize
	// FullName:  CListUI::SetIconImgSize
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: SIZE szIconImg
	// Note:	  
	//************************************
	...
	// FullName:  CListUI::GetCheckImgSize
	// Access:    public 
	// Returns:   SIZE
	// Qualifier: const
	// Note:	  
	...
	SIZE CListUI::GetCheckImgSize() const
	{
		...
		{
			throw "CListUI::GetCheckImgSize";
		}
	}

	//************************************
	// Method:    GetIconImgSize
	// FullName:  CListUI::GetIconImgSize
	// Access:    public 
	// Returns:   SIZE
	// Qualifier: const
	// Note:	  
	...
	// Returns:   BOOL
	// Qualifier:
	// Parameter: PULVCompareFunc pfnCompare
	// Parameter: UINT_PTR dwData
	// Note:	  
	//************************************
	BOOL CListUI::SortItems( PULVCompareFunc pfnCompare, UINT_PTR dwData )
	{
		...
		{
			throw "CListUI::SortItems";
		}
	}
	//************************************
	// Method:    SetMultipleItem
	// FullName:  CListUI::SetMultipleItem
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: bool bMultipleable
	// Note:	  
	//************************************
	...
	// FullName:  CListBodyUI::ItemComareFunc
	...
	int __cdecl CListBodyUI::ItemComareFunc( const void *item1, const void *item2 )
	{
		...
		{
			throw "CListBodyUI::ItemComareFunc";
		}
	}
	...
	//************************************
	// Method:    SortItems
	// FullName:  CListBodyUI::SortItems
	// Access:    public 
	// Returns:   BOOL
	// Qualifier:
	// Parameter: PULVCompareFunc pfnCompare
	...
	//************************************
	// Method:    Select
	// FullName:  CListTextElementUI::Select
	// Access:    public 
	// Returns:   bool
	// Qualifier:
	// Parameter: bool bSelect
	// Note:	  
	//************************************
	...
	//************************************
	// Method:    CListImageTextElementUI
	// FullName:  UiLib::CListImageTextElementUI::CListImageTextElementUI
	// Access:    public 
	// Returns:   
	// Qualifier: : m_aStartCheck(sizeof(bool)), m_aCheck(sizeof(bool))
	//************************************
	...
	//************************************
	// Method:    GetClass
	// FullName:  UiLib::CListImageTextElementUI::GetClass
	// Access:    public 
	// Returns:   LPCTSTR
	// Qualifier: const
	//************************************
	...
	//************************************
	// Method:    GetInterface
	// FullName:  UiLib::CListImageTextElementUI::GetInterface
	// Access:    public 
	// Returns:   LPVOID
	// Qualifier:
	...
	//************************************
	// Method:    SetNorImg
	// FullName:  UiLib::CListImageTextElementUI::SetNorImg
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    SetSelImg
	// FullName:  UiLib::CListImageTextElementUI::SetSelImg
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    SetCheckFlag
	// FullName:  UiLib::CListImageTextElementUI::SetCheckFlag
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: int iIndex
	// Parameter: bool bStartCheck
	//************************************
	...
	//************************************
	// Method:    GetCheckFlag
	// FullName:  UiLib::CListImageTextElementUI::GetCheckFlag
	// Access:    public 
	// Returns:   bool
	// Qualifier: const
	// Parameter: int iIndex
	...
	//************************************
	// Method:    SetCheck
	// FullName:  UiLib::CListImageTextElementUI::SetCheck
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    GetCheck
	// FullName:  UiLib::CListImageTextElementUI::GetCheck
	// Access:    public 
	// Returns:   bool
	// Qualifier: const
	// Parameter: int iIndex
	...
	//************************************
	// Method:    GetNorCheckImg
	// FullName:  UiLib::CListImageTextElementUI::GetNorCheckImg
	// Access:    public 
	// Returns:   LPCTSTR
	// Qualifier: const
	// Parameter: int iIndex
	...
	//************************************
	// Method:    GetSelCheckImg
	// FullName:  UiLib::CListImageTextElementUI::GetSelCheckImg
	// Access:    public 
	// Returns:   LPCTSTR
	// Qualifier: const
	// Parameter: int iIndex
	...
	//************************************
	// Method:    SetNorCheckImg
	// FullName:  UiLib::CListImageTextElementUI::SetNorCheckImg
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    SetSelCheckImg
	// FullName:  UiLib::CListImageTextElementUI::SetSelCheckImg
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    GetItemRect
	// FullName:  UiLib::CListImageTextElementUI::GetItemRect
	// Access:    public 
	// Returns:   RECT
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    GetItemRectPadding
	// FullName:  UiLib::CListImageTextElementUI::GetItemRectPadding
	// Access:    public 
	// Returns:   RECT
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    GetItemCheckRect
	// FullName:  UiLib::CListImageTextElementUI::GetItemCheckRect
	// Access:    public 
	// Returns:   RECT
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    GetItemImgRect
	// FullName:  UiLib::CListImageTextElementUI::GetItemImgRect
	// Access:    public 
	// Returns:   RECT
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    GetItemTextRect
	// FullName:  UiLib::CListImageTextElementUI::GetItemTextRect
	// Access:    public 
	// Returns:   RECT
	// Qualifier:
	// Parameter: int iIndex
	...
	//************************************
	// Method:    HitTest
	// FullName:  UiLib::CListImageTextElementUI::HitTest
	// Access:    public 
	// Returns:   int
	// Qualifier:
	// Parameter: POINT pt
	// Parameter: UINT * pFlags
	//************************************
	...
	//************************************
	// Method:    DoEvent
	// FullName:  UiLib::CListImageTextElementUI::DoEvent
	// Access:    public 
	// Returns:   void
	// Qualifier:
	...
	//************************************
	// Method:    DrawItemText
	// FullName:  UiLib::CListImageTextElementUI::DrawItemText
	// Access:    public 
	// Returns:   void
	// Qualifier:
	// Parameter: HDC hDC
	// Parameter: const RECT & rcItem
	//************************************
